...
import io.justdevit.kotlin.boost.domain.model.FilterOperator.GE
import io.justdevit.kotlin.boost.domain.model.FilterOperator.GT
import io.justdevit.kotlin.boost.domain.model.FilterOperator.IN
import io.justdevit.kotlin.boost.domain.model.FilterOperator.LE
import io.justdevit.kotlin.boost.domain.model.FilterOperator.LI
import io.justdevit.kotlin.boost.domain.model.FilterOperator.LT
import io.justdevit.kotlin.boost.domain.model.FilterOperator.NE
import io.justdevit.kotlin.boost.domain.model.FilterOperator.NI
import io.justdevit.kotlin.boost.domain.model.FilterOperator.NL
...
data class Filter<T>(
    ...
    val optimizedOperator: FilterOperator
        get() = when (operator) {
            IN if values.size == 1 -> EQ
            EQ if values.size > 1 -> IN
            else -> operator
        }
}
